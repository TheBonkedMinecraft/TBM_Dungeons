...
import org.tbm.server.dungeons.dungeons.packet.ModMessages;
import org.tbm.server.dungeons.dungeons.recipe.GemInfusingRecipe;
import org.tbm.server.dungeons.dungeons.screen.GemInfusingScreenHandler;
...
public class GemInfusingBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public static void tick(World world, BlockPos blockPos, BlockState state, GemInfusingBlockEntity entity) {
        ...
        if(hasRecipe(entity) && hasEnoughFluid(entity)) {
            entity.progress++;
