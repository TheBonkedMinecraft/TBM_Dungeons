...
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.items.BrewAction;
...
import static org.tbm.server.dungeons.dungeons.professions.profession.action.Actions.BREW_ITEM;
...
public class AlchemistProvider extends NamedProfessionBuilder {
    ...
    public void addData(ProfessionBuilder builder) {
        ...
        builder.addPerk(Perks.SCALING_ATTRIBUTE_PERK, ScalingAttributePerk.scaling()
                .level(10).attribute(Attributes.ARMOR_TOUGHNESS).increaseBy(0.02));
    }
}
