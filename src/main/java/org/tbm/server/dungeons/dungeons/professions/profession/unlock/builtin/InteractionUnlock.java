package org.tbm.server.dungeons.dungeons.professions.profession.unlock.builtin;
...
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.items.AbstractItemAction;
...
import static org.tbm.server.dungeons.dungeons.professions.profession.unlock.UnlockSerializer.INTERACTION_UNLOCK;
...
public class InteractionUnlock extends AbstractLevelUnlock<Item> {
    ...
    public List<Singular<Item>> convertToSingle(Profession profession) {
        ...
        for (Item real : convertToReal()) {
            list.add(new Single(real, level, profession));
        }
        return list;
    }
