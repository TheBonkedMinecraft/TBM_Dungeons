...
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.ExploreBiomeAction;
...
public class Actions {
    ...
    public static Object createGsonAdapter() {
        return GsonAdapterFactory.builder(RegistryConstants.ACTION_TYPE, "action", "action", Action::getType).build();
    }
