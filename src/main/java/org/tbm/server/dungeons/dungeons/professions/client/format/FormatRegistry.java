...
import org.tbm.server.dungeons.dungeons.professions.client.entry.*;
import org.tbm.server.dungeons.dungeons.professions.mixin.accessor.EnchantmentPredicateAccess;
import org.tbm.server.dungeons.dungeons.professions.profession.action.AbstractAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.blocks.BlockAbstractAction;
...
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.blocks.TntDestroyAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.entity.AbstractEntityAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.entity.BreedAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.entity.KillAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.entity.TameAction;
import org.tbm.server.dungeons.dungeons.professions.profession.action.builtin.items.*;
...
import org.tbm.server.dungeons.dungeons.professions.profession.unlock.builtin.BlockBreakUnlock;
import org.tbm.server.dungeons.dungeons.professions.profession.unlock.builtin.BlockDropUnlock;
import org.tbm.server.dungeons.dungeons.professions.profession.unlock.builtin.ToolUnlock;
...
import static org.tbm.server.dungeons.dungeons.professions.RegistryConstants.*;
