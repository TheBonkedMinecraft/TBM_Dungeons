...
public final class ProfessionUtilityEvents {
    ...
    public interface SerializerCallback {
        /**
         * Callback method to register your own Profession types. {@link org.tbm.server.dungeons.dungeons.professions.profession.action.Action Actions},
         * {@link org.tbm.server.dungeons.dungeons.professions.profession.conditions.ActionCondition ActionConditions},
         * and {@link org.tbm.server.dungeons.dungeons.professions.profession.rewards.Reward rewards} all get serialized on their own.
         */
